...
import net.adventureg147.giantpacman.common.item.ThankYouBlackout;
...
public class GPItems {
	...
	public static final RegistryObject<ThankYouBlackout> THANK_YOU_BLACKOUT = ITEMS.register("thank_you_blackout",
			() -> new ThankYouBlackout(new Item.Properties().tab(GPItemGroup.PACMAN_GROUP)));
}
